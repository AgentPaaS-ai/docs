...
const config: Config = {
  ...
  themeConfig: {
    ...
    footer: {
      style: 'dark',
      links: [
        {title: 'Docs', items: [{label: 'Start here', to: '/'}, {label: 'Trial guide', to: '/trial/'}, {label: 'AgentPaaS CLI', to: '/cli/'}, {label: 'Release v0.4.0', to: '/releases/v0.4.0'}, {label: 'Versioning', to: '/versioning'}]},
